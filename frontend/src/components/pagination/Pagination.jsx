...
export default function Pagination({page, pages, changePage}) {
    ...
    return  pages > 1 &&(
        <div className="pagination">
            <button className="pagination-previous" onClick={() => changePage((page) => page - 1)} disabled={page === 1}>&#171;</button>
            {middlePagination}
            <button className="pagination-next" onClick={() => changePage((page) => page + 1)} disabled={page === pages}>&#187;</button>
        </div>
    )
}
